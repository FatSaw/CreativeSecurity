...
public enum XMaterial {
    ...
    private XMaterial(String m, int data) {
        this.m = m;
        this.data = data;
    }
    ...
    public static XMaterial requestXMaterial(String name, byte data) {
        ...
        for (XMaterial mat : XMaterial.values()) {
            if (!name.toUpperCase().equals(mat.m) || (byte)mat.data != data) continue;
    ...
    public boolean isSameMaterial(ItemStack comp) {
        ...
        XMaterial xmat = XMaterial.fromMaterial(comp.getType());
    ...
    public static XMaterial fromMaterial(Material mat) {
        try {
            ...
            for (XMaterial xmat : XMaterial.values()) {
                if (!xmat.m.equals(mat.toString())) continue;
                return xmat;
            }
            return null;
        }
    ...
    public static XMaterial fromString(String key) {
        try {
            XMaterial xmat = XMaterial.valueOf(key);
            return xmat;
        }
        catch (IllegalArgumentException e) {
            String[] split = key.split(":");
            XMaterial xmat = split.length == 1 ? XMaterial.requestXMaterial(key, (byte)0) : XMaterial.requestXMaterial(split[0], (byte)Integer.parseInt(split[1]));
            return xmat;
        }
    }
    ...
    public Material parseMaterial() {
        ...
        try {
            this.material = XMaterial.isNewVersion() ? Material.matchMaterial((String)this.toString()) : Material.matchMaterial((String)this.m);
        }
