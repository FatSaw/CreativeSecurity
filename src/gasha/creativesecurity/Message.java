...
public enum Message {
    ...
    DAMAGE_ZOMBIE_PIGMAN("damage-zombie-pigman"),
    ...
    CMDBLOCK_USAGE("cmdblock-usage"),
    CMDBLOCK_INVALID_RADIUS("cmdblock-invalid-radius"),
    CMDBLOCK_TOOBIG_RADIUS("cmdblock-toobig-radius"),
    CMDBLOCK_INVALID_CMD("cmdblock-invalid-cmd"),
    CMDBLOCK_NO_TARGETS("cmdblock-no-targets"),
    CMDBLOCK_SUCCESS("cmdblock-success"),
    ...
    BUCKET_CREATIVE("bucket-creative"),
