...
enum EnchantmentCompat {
	...
	protected final String namedKey;
    protected final String legacyName;
    ...
    protected static EnchantmentCompat getByNamedKey(String namedKey) {
    ...
    @Deprecated
    protected static EnchantmentCompat getByLegacyName(String legacyName) {
    ...
    @Deprecated
    protected static EnchantmentCompat getByLegacyId(int legacyId) {
        for (EnchantmentCompat enchantmentCompat : EnchantmentCompat.values()) {
